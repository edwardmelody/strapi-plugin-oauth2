...
const oauthClient$2 = strapi$1.factories.createCoreController(
...
const oauthGlobalSetting$2 = strapi$1.factories.createCoreController("plugin::strapi-plugin-oauth2.oauth-global-setting");
...
const oauthAccessToken = strapi$1.factories.createCoreService(
  "plugin::strapi-plugin-oauth2.oauth-access-token",
  ({ strapi: strapi2 }) => ({
...
const oauthClient = strapi$1.factories.createCoreService(
  "plugin::strapi-plugin-oauth2.oauth-client",
  ({ strapi: strapi2 }) => ({
...
const oauthGlobalSetting = strapi$1.factories.createCoreService("plugin::strapi-plugin-oauth2.oauth-global-setting");
